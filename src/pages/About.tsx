          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <AnimatedSection direction="left">
                <div className="aspect-square max-w-md mx-auto lg:mx-0 rounded-xl bg-charcoal p-8 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-32 h-32 rounded-full bg-gold/20 border-4 border-gold flex items-center justify-center mx-auto mb-6">
                      <span className="font-display text-5xl font-bold text-gold">SD</span>
                    </div>
                    <h3 className="font-display text-2xl font-bold text-off-white mb-2">
                      Siddh Dhingra
                    </h3>
                    <p className="font-body text-gold">Founder & Lead Consultant</p>
                  </div>
                </div>
              </AnimatedSection>
              ...
              <AnimatedSection direction="right">
                ...
                <p className="font-body text-muted-foreground leading-relaxed mb-6">
                  ...
                  Siddh founded Solitic Consulting to bridge the gap between legal complexity and business clarity.
                </p>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {outcomes.map((outcome, index) => (
                <AnimatedSection key={index} delay={index * 0.1}>
                  <div className="flex items-center gap-4 p-4 rounded-lg border border-off-white/10 bg-off-white/5">
                    <CheckCircle className="w-6 h-6 text-gold flex-shrink-0" />
                    <span className="font-body text-off-white">{outcome}</span>
                  </div>
                </AnimatedSection>
              ))}
            </div>
